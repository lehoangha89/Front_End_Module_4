...
!function (e, t) {
  ...
  !function (z) {
    ...
    Y.VERSION = "1.13.14", Y.DEFAULTS = {
      ...
      noneResultsText: "Không có kết quả khớp với {0}",
      ...
      constructor: Y, init: function () {
        ...
        var e = this.multiple || this.options.showTick ? " show-tick" : "",
          t = this.multiple ? ' aria-multiselectable="true"' : "", i = "", s = this.autofocus ? " autofocus" : "";
        ...
        if (e || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
          ...
          var v, g = l.offsetHeight, b = r ? r.offsetHeight : 0, w = d ? d.offsetHeight : 0, I = h ? h.offsetHeight : 0,
            x = p ? p.offsetHeight : 0, k = u ? u.offsetHeight : 0, y = z(o).outerHeight(!0),
            $ = !!window.getComputedStyle && window.getComputedStyle(i), S = i.offsetWidth, E = $ ? null : z(i), C = {
        ...
        var t, i, s, n, o, r, l, a, c = this.sizeInfo.selectWidth, d = this.sizeInfo.liHeight,
          ...
          f = this.sizeInfo.doneButtonHeight, m = this.sizeInfo.dividerHeight, v = this.sizeInfo.menuPadding, g = 0;
        ...
        t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
          ...
          var i = z(this), s = C.$element[0], n = C.isVirtual() ? C.selectpicker.view.position0 : 0,
            o = C.selectpicker.current.data[i.parent().index() + n], r = o.index, l = T(s), a = s.selectedIndex,
            c = s.options[a], d = !0;
              ...
              if (h.selected = !u, C.setSelected(r, !u), i.trigger("blur"), !1 !== v || !1 !== g) {
                ...
                if (v && b || g && w) if (v && 1 == v) s.selectedIndex = -1, h.selected = !0, C.setOptionStatus(!0); else if (g && 1 == g) {
                  ...
                  var k = "string" == typeof C.options.maxOptionsText ? [C.options.maxOptionsText, C.options.maxOptionsText] : C.options.maxOptionsText,
                    y = "function" == typeof k ? k(v, g) : k, $ = y[0].replace("{n}", v), S = y[1].replace("{n}", g),
        ...
        var t, i, s, n, o, r = z(this), l = r.hasClass("dropdown-toggle"),
          ...
          h = e.which === W && !l && !a.options.selectOnTab, p = G.test(e.which) || h, u = a.$menuInner[0].scrollTop,
